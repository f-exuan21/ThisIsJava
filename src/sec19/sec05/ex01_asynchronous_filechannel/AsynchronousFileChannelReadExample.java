package sec19.sec05.ex01_asynchronous_filechannel;
...
public class AsynchronousFileChannelReadExample {
    public static void main(String[] args) throws Exception {
        ...
        for(int i=0; i<10; i++) {
            Path path = Paths.get("src/sec19/sec05/ex01_asynchronous_filechannel/Temp/file" + i + ".txt");
            ...
            ByteBuffer byteBuffer = ByteBuffer.allocate((int)fileChannel.size()); //파일의 사이즈만큼 지정
